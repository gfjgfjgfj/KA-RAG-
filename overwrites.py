...
from utils import convert_bot_before_marked, convert_user_before_marked
...
def list_scripts(scriptdirname, extension):
    scripts_list = []
    scripts_dir = f"assets/{scriptdirname}"
    if os.path.exists(scripts_dir):
        for filename in sorted(os.listdir(scripts_dir)):
            scripts_list.append(ScriptFile("/assets", filename, os.path.join(scripts_dir, filename)))
